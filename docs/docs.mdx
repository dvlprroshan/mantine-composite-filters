...
See how `MultiFiltersInput` powers different types of applications. Each demo below represents a complete, production-ready implementation.

### 🛒 E-commerce Product Catalog

Filter through product inventories with price ranges, categories, ratings, stock status, and more. Perfect for online stores and marketplaces.

<Demo data={demos.ecommerceProducts} />

### 🐛 Issue Tracker (GitHub/JIRA Style)

Track bugs, features, and tasks with priority levels, assignees, labels, and status tracking. Ideal for development teams.

<Demo data={demos.issueTracker} />

### 💼 CRM Sales Pipeline

Manage leads through your sales funnel with deal values, lead scores, pipeline stages, and sales rep assignments.

<Demo data={demos.crmLeads} />

### 🎧 Help Desk & Support Tickets

Handle customer support tickets with priority, SLA tracking, satisfaction ratings, and multi-channel support.

<Demo data={demos.helpDesk} />

### 💰 Financial Transactions

Track income, expenses, and transfers across accounts with category filtering, date ranges, and payment methods.

<Demo data={demos.transactions} />

### 📊 Analytics Dashboard

Monitor website traffic with visitor metrics, page views, device types, browsers, and geographic data.

<Demo data={demos.analyticsDashboard} />

### 👥 User Management Dashboard

A classic example for admin panels - filter users by role, status, tags, and activity dates.
